...
import { Home, Bed, Bath, Square, MapPin, Eye, Check, X, FileText, CheckCircle, AlertCircle, Download, Send } from "lucide-react"
...
export function PropertyDetailsView({ property, actionButton, tabs, activeTab, setActiveTab, belowLocation, applications, leases, onApplicationStatusChange }: {
  ...
  const handleSubmitInvoice = async () => {
    if (!selectedLeaseForInvoice || !property) return
    ...
    try {
      const invoiceData = {
        ...
        renterEmail: selectedLeaseForInvoice.renterId || selectedLeaseForInvoice.receiverEmail,
        renterId: selectedLeaseForInvoice.renterId || selectedLeaseForInvoice.receiverEmail,
